...
const GroupXpPoints = ({ assignmentScore }) => {
  const breakdown = assignmentScore.groupXPBreakdown || {};

  return (
    <div className="flex flex-col gap-6 border border-gray-200 bg-white p-6 rounded-2xl shadow-sm">
